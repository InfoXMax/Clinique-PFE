                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter Médicaments</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Créer un Médicaments</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                            <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Catégorie de Médicaments</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Vendeur de Médicaments</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Barcode(EAN-8)</label>
                                                    <?php 
                                                        $length = 10;    
                                           ...
                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Ajouter le Médicament</button>
