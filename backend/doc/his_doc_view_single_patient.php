                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Voir les Patients</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Nom et Prénom :</strong> <span class="ml-2"><?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Téle :</strong><span class="ml-2"><?php echo $row->pat_phone;?></span></p>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th> rate cardiaque / impulsion </th>
                                                            <th> Rate respiratory </th>
                                                            <th> Pression artérielle </th>
                                                            <h> Date enregistrée </th>
                                                        </tr>
                                                    </thead>
                                                    <?php
