                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nom : <?php echo $row->phar_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger"> Fournisseuse : <?php echo $row->phar_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger"> Quantité : <?php echo $row->phar_qty;?> Cartons</h4>
                                                    <hr>
