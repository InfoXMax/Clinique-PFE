                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="his_doc_dashboard.php">Tableau de borde bord</a></li>
                                        ...
                                        <form method="post">
                                            <div class="form-row" >
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputEmail4" class="col-form-label">Nom de la catégorie Medicament</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputPassword4" class="col-form-label">Vendeur de la catégorie Medicament</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Description de la catégorie Medicament</label>
                                           ...
                                           <button type="submit" name="update_pharmaceutical_category" class="ladda-button btn btn-danger" data-style="expand-right">Mise à jour Catégorie </button>
