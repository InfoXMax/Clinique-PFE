                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Afficher mon profil</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                       ...
                                       <p class="text-muted mb-2 font-13"><strong>Spécialité du médecin:</strong> <span class="ml-2"><?php echo $row->doc_dept;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Numéro de médecin:</strong> <span class="ml-2"><?php echo $row->doc_number;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email du médecin:</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
