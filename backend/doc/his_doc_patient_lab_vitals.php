                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter les signes vitaux du patient</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Capturer les vitaux</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_add_single_patient_vitals.php?pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="mdi mdi-beaker "></i>Capturer les vitaux</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
