                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Patients de décharge</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Patient de sortie</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Numéro de portable</label>
                                                    <input required="required" type="text" value="<?php echo $row->pat_phone;?>" name="pat_phone" class="form-control" id="inputCity">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Adresse</label>
                                            ...
                                            <button type="submit" name="discharge_patient" class="ladda-button btn btn-success" data-style="expand-right">Décharge</button>
