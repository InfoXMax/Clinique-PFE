                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Voir les catégories Medicaments</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nom : <?php echo $row->pharm_cat_name;?></h2>
                                                    <hr>
                                                    <h6 class="text-danger"> Fournisseuse<?php echo $row->pharm_cat_vendor;?></h6>
                                                    <hr>
