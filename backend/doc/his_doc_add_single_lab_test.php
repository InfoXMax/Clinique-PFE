                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Numéro de test de laboratoire</label>
                                                ...
                                                <button type="submit" name="add_patient_lab_test" class="ladda-button btn btn-success" data-style="expand-right">Ajouter un test de laboratoire</button>
