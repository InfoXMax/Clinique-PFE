                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide = "téléphone"> Test de laboratoire de date effectué </th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_add_single_lab_result.php?lab_number=<?php echo $row->lab_number ;?>" class="badge badge-success"><i class="mdi mdi-flask"></i>Ajouter le résultat du laboratoire</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
