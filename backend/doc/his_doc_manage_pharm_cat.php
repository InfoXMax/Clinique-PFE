                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Gérer les catégories de Médicaments</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Nom de la Catégorie</th>
                                                 <th data-hide="phone">Fournisseur de Catégorie</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_pharm_category.php?pharm_cat_id=<?php echo $row->pharm_cat_id;?>" class="badge badge-success"><i class="far fa-eye "></i> Voir</a>
