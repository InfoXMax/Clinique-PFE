                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Ajouter le résultat du laboratoire</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Ajouter le résultat du laboratoire</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Résultat de laboratoire</label>
                                                        <textarea required="required"   type="text" class="form-control" name="lab_pat_results" id="editor1"></textarea>
                                                </div>

                                                <button type="submit" name="add_patient_lab_result" class="ladda-button btn btn-success" data-style="expand-right">Ajouter un résultat de laboratoire</button>
