                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" name="pat_fname" class="form-control" id="inputEmail4" placeholder="">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Nom de famille</label>
                                                    <input required="required" type="text" name="pat_lname" class="form-control"  id="inputPassword4" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="pat_age" class="form-control"  id="inputPassword4" placeholder="">
                                                </div>
                                            </div>
                                            <script>
  ...
  document.querySelector('input[name="pat_dob"]').addEventListener('input', (event) => {
    ...
    ageInput.value = age;
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required="required" type="text" class="form-control" name="pat_addr" id="inputAddress" placeholder="">
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Numero du Patient</label>
