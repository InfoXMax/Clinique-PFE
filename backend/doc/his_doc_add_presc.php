                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter une Ordonnances</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter les Ordonnances</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_add_single_pres.php?pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="fas fa-highlighter "></i>Ajouter l'Ordonnance</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
