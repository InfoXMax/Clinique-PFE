                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Ajouter un dossier médical</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Prescription du patient</label>
                                                        <textarea required="required"  type="text" class="form-control" name="mdr_pat_prescr" id="editor"><?php echo $row->pres_ins;?> </textarea>
                                                </div>
                                                <?php }?>

                                                <button type="submit" name="add_patient_mdr" class="ladda-button btn btn-primary" data-style="expand-right">Ajouter un dossier médical patient</button>
