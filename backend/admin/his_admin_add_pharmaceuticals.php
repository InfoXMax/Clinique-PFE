                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter pharmaceutique</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Créer un pharmaceutique</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                           ...
                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Ajouter pharmaceutique</button>
