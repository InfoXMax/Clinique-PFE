<?php
  ...
  if(isset($_GET['delete_pharm_name']))
  {
        ...
        $stmt->close();	 
          ...
          if($stmt)
          {
            $success = "Dossiers pharmaceutiques supprimés";
          }
            else
            {
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-success"><i class="far fa-eye "></i> Voir</a>
                                                        <a href="his_admin_update_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-warning"><i class="fas fa-clipboard-check "></i> Mise à jour</a>
                                                        <a href="his_admin_manage_pharmaceuticals.php?delete_pharm_name=<?php echo $row->phar_id;?>" class="badge badge-danger"><i class="fas fa-trash-alt"></i> Supprimer</a>
