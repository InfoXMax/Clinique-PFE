                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Test de laboratoire de date effectué</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_lab_record.php?lab_id=<?php echo $row->lab_id ;?>&&lab_number=<?php echo $row->lab_number ;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> Afficher le rapport de laboratoire</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
