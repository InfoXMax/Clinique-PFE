                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Gérer la catégorie Médicaments</li>
                                        </ol>
                                    </div>
                                        ...
                                        <form method="post">
                                            <div class="form-row" >
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputPassword4" class="col-form-label">Vendeur</label>
                                           ...
                                           <button type="submit" name="update_pharmaceutical_category" class="ladda-button btn btn-danger" data-style="expand-right">Mise à jour</button>
