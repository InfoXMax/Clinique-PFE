                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Transférer un Médecin</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Transfert de médecin d'une spécialité à l'autre</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Numéro de médecin</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Spécialité Actuel </label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputState" class="col-form-label">Nouvelle Spécialité</label>
                                            ...
                                            <button type="submit" name="trans_dept" class="ladda-button btn btn-success" data-style="expand-right">Transférer le Médecin</button>
