                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_pres.php?pres_number=<?php echo $row->pres_number;?>&&pres_id=<?php echo $row->pres_id;?>" class="badge badge-success"><i class="fas fa-eye"></i>Afficher la prescription</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
