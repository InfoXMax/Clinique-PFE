<?php
  ...
  if(isset($_GET['delete_pres_number']))
  {
        ...
        $stmt->close();	 
          ...
          if($stmt)
          {
            $success = "Enregistrements de prescription supprimés";
          }
            else
            {
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_view_single_pres.php?pres_number=<?php echo $row->pres_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> Voir</a>
                                                        <a href="his_admin_upate_single_pres.php?pres_number=<?php echo $row->pres_number;?>" class="badge badge-warning"><i class="fas fa-eye-dropper "></i> Mise à jour</a>
