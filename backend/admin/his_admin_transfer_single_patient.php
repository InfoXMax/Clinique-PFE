                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Transférer les patients</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Transférer le patient dans un établissement de référence</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Hôpital de référence</label>
                                                    <input type="text" required="required"  name="t_hospital" class="form-control" id="inputEmail4" placeholder="Hôpital de référence / transfert">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Date de transfert</label>
                                                    <input required="required" type="date"  name="t_date" class="form-control"  id="inputPassword4" placeholder="DD/MM/YYYY">
                                                </div>
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Numéro de patient </label>
                                            ...
                                            <div class="form-group" style="display:none">
                                                <label for="inputAddress" class="col-form-label">Statut de transfert</label>
                                            ...
                                            <button type="submit" name="transfer_patient" class="ladda-button btn btn-success" data-style="expand-right">Transférer le patient</button>
