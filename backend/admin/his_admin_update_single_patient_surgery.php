	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Chirurgie Détails du patient mis à jour";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Gérer les patients</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Gérer les détails des patients chirurgicales</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Statut de chirurgie</label>
                                            ...
                                            <button type="submit" name="update_patient" class="ladda-button btn btn-warning" data-style="expand-right">Mettre à jour</button>
