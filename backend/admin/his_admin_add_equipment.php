                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Chirurgie / théâtre</a></li>
                                            <li class="breadcrumb-item active">Ajouter des équipements</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Équipements chirurgicaux</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Vendeur d'équipement</label>
                                                    <input required="required" type="text" name="eqp_vendor" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Quantité d'équipement </label>
                                                    <input required="required" type="text"  name="eqp_qty" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-4" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Département de l'équipement</label>
                                                    <input required="required" type="text" value="Surgical | Theatre" name="eqp_dept" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">État de l'équipement</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Code à barres de l'équipement (EAN-8)</label>
                                                    <?php 
                                                        $length = 10;    
                                           ...
                                           <button type="submit" name="add_equipments" class="ladda-button btn btn-success" data-style="expand-right">Ajouter des équipements</button>
