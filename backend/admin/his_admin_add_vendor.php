                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Fournisseuse</a></li>
                                            <li class="breadcrumb-item active">Ajouter le vendeur</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter les détails du vendeur</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputEmail4" class="col-form-label">Nom du vendeur</label>
                                                    <input type="text" required="required" name="v_name" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Numéro de téléphone du vendeur</label>
                                                    <input required="required" type="text" name="v_phone" class="form-control"  id="inputPassword4">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputPassword4" class="col-form-label">Adresse du vendeur</label>
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Numéro de vendeur</label>
                                                    <input type="text" name="v_number" value="<?php echo $vendor_number;?>" class="form-control" id="inputZip">
                                                </div>

                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">E-mail du vendeur</label>
                                                <input required="required" type="email" class="form-control" name="v_email" id="inputAddress">
                                            </div>

                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Détails du vendeur</label>
                                                <textarea  type="text" class="form-control" name="v_desc" id="editor"></textarea>
                                            </div>

                                            <button type="submit" name="add_vendor" class="ladda-button btn btn-success" data-style="expand-right">Ajouter le vendeur</button>
