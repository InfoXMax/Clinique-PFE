                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?>'s Profil</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        ...
                                        <div class="text-left mt-3">
                                            <p class="text-muted mb-2 font-13"><strong>Nom et prénom :</strong> <span class="ml-2"><?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?></span></p>
                                            <p class="text-muted mb-2 font-13"><strong>E-mail :</strong> <span class="ml-2 "><?php echo $row->ad_email;?></span></p>
                                        </div>
