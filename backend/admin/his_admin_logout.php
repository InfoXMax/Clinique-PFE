...
<head>
        <meta charset="utf-8" />
        <title>Système de gestion de Clinique</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span><img src="assets/images/logo-dark.png" alt="" height="45"></span>
                                    </a>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Retour à <a href="index.php" class="text-white ml-1"><b> La Connexion </b></a> OU à <a href="../../index.php" class="text-white ml-1"><b> la page D'Accueil</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
