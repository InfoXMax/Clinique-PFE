                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Mettre à jour le vendeur</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Mettre à jour les détails du fournisseur</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <button type="submit" name="update_vendor" class="ladda-button btn btn-success" data-style="expand-right">Mettre à jour le vendeur</button>
