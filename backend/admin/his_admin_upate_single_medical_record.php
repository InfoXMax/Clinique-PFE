                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Gérer le dossier médical</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Mettre à jour le dossier médical</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" required="required" readonly name="mdr_pat_name" value="<?php echo $row->mdr_pat_name;?>" class="form-control" id="inputEmail4" placeholder="Le nom du patient">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Age</label>
                                                        <input required="required" type="text"  name="mdr_pat_age" value="<?php echo $row->mdr_pat_age;?>" class="form-control"  id="inputPassword4" placeholder="">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Adresse</label>
                                                        <input required="required" type="text"  name="mdr_pat_adr" value="<?php echo $row->mdr_pat_adr;?>" class="form-control"  id="inputPassword4" placeholder="">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="mdr_pat_number" value="<?php echo $row->mdr_pat_number;?>" class="form-control" id="inputEmail4" placeholder="JJ/MM/AAAA">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Numéro de dossier médical</label>
                                                ...
                                                <button type="submit" name="update_patient_mdr" class="ladda-button btn btn-warning" data-style="expand-right">Mettre à jour le dossier médical des patients</button>
