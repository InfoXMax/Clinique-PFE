                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Gérer l'équipement</a></li>
                                                <li class="breadcrumb-item active">Mettre à jour l'équipement</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Mettre à jour les détails de l'équipement</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
