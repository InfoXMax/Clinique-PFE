...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['assaign_dept']))
		{
			...
			if($stmt)
			{
				$success = "Spécialité assigné aux médecin";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Attribuer une Spécialité</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Attribuer une Spécialité</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                    <label for="inputState" class="col-form-label">Spécialité</label>
                                                    <select id="inputState" required="required" name="doc_dept" class="form-control">
                                                        ...
                                                        <option>Chirurgienne</option>
                                                       
                                                    </select>
                                            </div>                                        

                                            <button type="submit" name="assaign_dept" class="ladda-button btn btn-success" data-style="expand-right">Attribuer Spécialité</button>
