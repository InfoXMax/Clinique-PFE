                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4" class="col-form-label">Nom de l'employé</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Département des employés</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inputEmail4" class="col-form-label">Numéro d'employé</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Paute cardiaque du patient / battement de BPM</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label for="inputPassword4" class="col-form-label">Patication de la pression artérielle MMHG</label>
                                                        <input required="required" type="text"  name="vit_bloodpress"  class="form-control"  id="inputPassword4" placeholder="mmHg">
                                                    </div>

                                                </div>

                                                <button type="submit" name="add_emp_vitals" class="ladda-button btn btn-success" data-style="expand-right">Ajouter les signes vitaux</button>
