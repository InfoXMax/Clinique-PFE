                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter le patient</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ajouter les détails des patients en chirurgie</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" readonly required="required" value="<?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?>" name="s_pat_name" class="form-control" id="inputEmail4" placeholder="">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Maladie</label>
                                                    <input readonly required="required" type="text" value="<?php echo $row->pat_ailment;?>" name="s_pat_ailment" class="form-control"  id="inputPassword4" placeholder="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input readonly type="text" required="required" value="<?php echo $row->pat_number;?>" name="s_pat_number" class="form-control" id="inputEmail4" placeholder="JJ/MM/AAAA">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Chirurgienne</label>
                                                    <select id="inputState" required="required" name="s_doc" class="form-control">
                                                    <?php
                                                    
                                                        $ret="SELECT * FROM  his_docs WHERE doc_dept = 'Chirurgienne' ORDER BY RAND() "; 
                                                ...
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputPassword4" class="col-form-label">Statut de chirurgie</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Numéro de dossier de chirurgie</label>
                                                    <input type="text" name="s_number" value="<?php echo $s_number;?>" class="form-control" id="inputZip">
                                                </div>
                                            </div>

                                            <button type="submit" name="add_patient" class="ladda-button btn btn-success" data-style="expand-right">Ajouter le patient</button>
