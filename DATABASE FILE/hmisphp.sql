...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2023 at 07:13 PM
...
INSERT INTO `appointment_list` (`id`, `doc_id`, `pat_id`, `name`, `email`, `schedule`, `status`, `date_created`, `doctor_name`) VALUES
(129, 5, 0, 'Ahmed Kalaaji', 'Kalaaji@mail.ma', '2023-04-18 09:31:00', 0, '2023-04-15 02:31:50', 'Malak Mansouri'),
(130, 6, 0, 'Lamia Alaoui', 'Alaoui@mail.ma', '2023-04-18 10:30:00', 0, '2023-04-15 02:32:47', 'Ali Berrada'),
(131, 6, 0, 'Ahmed Kalaaji', 'Kalaaji@mail.ma', '2023-04-16 09:31:00', 0, '2023-04-15 03:20:42', 'Ali Berrada'),
(132, 6, 0, 'Maha Adoul', 'm.adoul@gmail.com', '2023-04-16 09:31:00', 0, '2023-04-15 03:21:40', 'Ali Berrada');
...
(45, 5, 'Lundi', '08:00:00', '12:00:00'),
(46, 5, 'Mercredi', '09:00:00', '13:00:00'),
(47, 6, 'Mercredi', '10:00:00', '14:00:00'),
(48, 6, 'Vendredi', '09:00:00', '13:00:00'),
(49, 12, 'Mardi', '11:00:00', '15:00:00'),
(50, 34, 'Mercredi', '10:00:00', '14:00:00');
...
(2, '', 'Houssine', 'h@mail.com', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'admin.png');
...
INSERT INTO `his_docs` (`doc_id`, `doc_fname`, `doc_lname`, `doc_email`, `doc_pwd`, `doc_dept`, `doc_number`, `doc_dpic`, `doc_image`) VALUES
(5, 'Malak', 'Mansouri', 'Mansouri20@mail.com', 'dce0b27ba675df41e9cc07af80ec59c475810824', 'Laboratory', '564XD', 'doc-icon.png', 'team-5.jpg'),
(6, 'Ali', 'Berrada', 'berrada@mail.com', '55c3b5386c486feb662a0785f340938f518d547f', 'Surgery | Theatre', 'YDS7L', 'doc-icon.png', 'team-2.jpg'),
(12, 'Ahmed', 'Trabelsi', 'Trabelsi@mail.com', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'Accounting', '5VIFT', 'doc-icon.png', 'team-4.jpg'),
(34, 'Asmaa', 'Dhebi', 'Dhebi@mail.com', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'Dermatologue', 'VMTQD', 'doc-icon.png', 'team-3.jpg');
...
(1, 'Bennani Anouar', 'Diabéte', '7EW0L', '<ul><li><a href=\"https://www.medicalnewstoday.com/articles/179211.php\">Non-steroidal anti-inflammatory drugs</a> (NSAIDs) such as <a href=\"https://www.medicalnewstoday.com/articles/161255.php\">aspirin</a> or ibuprofen can help bring a fever down. These are available to purchase over-the-counter or <a target=\"_blank\" href=\"https://amzn.to/2qp3d0b\">online</a>. However, a mild fever may be helping combat the bacterium or virus that is causing the infection. It may not be ideal to bring it down.</li><li>If the fever has been caused by a bacterial infection, the doctor may prescribe an <a href=\"https://www.medicalnewstoday.com/articles/10278.php\">antibiotic</a>.</li><li>If a fever has been caused by a cold, which is caused by a viral infection, NSAIDs may be used to relieve uncomfortable symptoms. Antibiotics have no effect against viruses and will not be prescribed by your doctor for a viral infection.</li></ul>', '<ul><li>If the fever has been caused by a bacterial infection, the doctor may prescribe an <a href=\"https://www.medicalnewstoday.com/articles/10278.php\">antibiotic</a>.</li><li>If a fever has been caused by a cold, which is caused by a viral infection, NSAIDs may be used to relieve uncomfortable symptoms. Antibiotics have no effect against viruses and will not be prescribed by your doctor for a viral infection.</li></ul>', 'K67PL', '2023-04-15 00:13:49'),
(2, 'Tazi Meryem', 'Allérgie', '6P8HJ', '<ul><li>Body temperature</li><li>Blood</li><li>Stool</li><li>Urine</li></ul>', '<ul><li>Body Temperature 67 Degree Celcious(Abnormal)</li><li>Blood - Malaria Bacterial Tested Postive</li><li>Stool - Mucus tested postive</li><li>Urine -Urea Level were 20% higher than normal</li></ul><p><strong>Fever Tested Positive</strong></p>', '9DMN5', '2023-04-15 00:14:52'),
(3, 'Dsouli Imad', 'Oreillons', 'RAV6C', '<p><strong>Pain areas: </strong>in the abdomen or muscles</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating</p><p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting</p><p><strong>Also common: </strong>fast heart rate, headache, mental confusion, or pallor</p>', '<p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating - Tested Positive</p><p><strong>Gastrointestinal: </strong>diarrhoea, nausea, or vomiting - Tested Positive</p><p>&nbsp;</p>', '90ZNX', '2023-04-15 00:16:07'),
(4, 'Boustane Douaa', 'Diarrhée', '3Z14K', '<p>demo demo demo demo</p>', '<p>54545</p>', 'G0VZU', '2023-04-15 00:17:31'),
(5, 'Asmaa Amrani', 'Obésité', '4TLG0', '<ol><li>Test One</li><li>Test Two</li><li>Test Three</li><li>Test Four</li><li>Test Five</li></ol>', '<ol><li>Result One</li><li>Result Two</li><li>Result Three</li></ol>', 'RA4UM', '2023-04-15 00:20:36');
...
(1, 'ZNXI4', 'Dounia Alaoui', 'Massira Casablanca', '35', 'Malaria', 'RAV6C', '<ul><li>Combination of atovaquone and proguanil (Malarone)</li><li>Quinine sulfate (Qualaquin) with doxycycline (Vibramycin, Monodox, others)</li><li>Mefloquine.</li><li>Primaquine phosphate.</li></ul>', '2023-04-15 22:32:44.3794'),
(2, 'MIA9P', 'Hiba Saadi', 'Kasbaa Marrakech', '22', 'Demo Test', '3Z14K', NULL, '2023-04-15 22:32:27.9260'),
(3, 'F1ZHQ', 'Saad Nousairi', 'Av Mohammed 5 Marrakech', '30', 'Demo Test', 'DCRI8', NULL, '2023-04-15 22:32:56.9419'),
(4, 'ZLN0Q', 'Ayoub Snousi', ' Medina Marrakech', '32', 'Demo Test', 'ISL1E', '<ol><li>sample</li><li>sampl</li><li>sample</li><li>sample</li></ol>', '2023-04-15 22:33:28.7403');
...
INSERT INTO `his_patients` (`pat_id`, `pat_fname`, `pat_lname`, `pat_dob`, `pat_age`, `pat_number`, `pat_addr`, `pat_phone`, `pat_type`, `pat_date_joined`, `pat_ailment`) VALUES
(13, 'Ahmed', 'Kalaaji', '15/10/1997', '24', '30J8E', 'Gueliz Marrakech ', '065465464', 'Ambulatoire', '2023-04-15 00:05:06.339426', 'Fiévre'),
(14, 'Hicham', 'Malouki', '15/10/2000', '23', '9TRSG', 'Massira Marrakech', '0654654579', 'Hospitalisé', '2023-04-15 00:07:27.838673', 'Fiévre');
...
(3, 'M V', '2023-04-09', 'Akagami Shanks', '75CIM', 'Success');
...
(7, 'Trafargal Law', '23', '9TRSG', 'G6HXT', 'kjlgjlkgtoiuyb', 'Hospitalisé', '2023-04-15 01:46:48.4807', 'jlkhfjlhgjl', '<p>pren 2 dolipran par jour</p>');
...
(2, '8KQWD', 'Bennani Anouar', 'RAV6C', 'Achraf Elfitouri', 'Trouble anxieux', '2023-04-15 00:22:37.013515', 'Successful'),
(3, '0612345678', 'Boustane Douaa', '3Z14K', 'Jaabari Oussama', 'Ophtamologique', '2023-04-15 00:24:16.622323', 'Successful'),
(4, 'ECF62', 'Ahmed Trabelsi', '4TLG0', 'Nazim Haddad', 'urologique', '2023-04-15 00:27:05.617044', 'Successful');
...
--
ALTER TABLE `his_docs`
  MODIFY `doc_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
